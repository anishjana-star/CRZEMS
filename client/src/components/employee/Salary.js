...
const Salary = () => {
    ...
    const filteredPayslips = salaryData.payslips.filter(payslip => {
        if (!searchTerm) return true;
        const term = searchTerm.toLowerCase();
        const name = (payslip.name || '').toLowerCase();
        const date = formatDate(payslip.month).toLowerCase();
        ...
        <div className="salary-section">
            ...
            <div className="salary-grid">
                ...
                <div className="salary-section-card">
                    ...
                    {/* Search Bar */}
                    <div className="payslip-search-container" style={{ marginBottom: '1.5rem' }}>
                    ...
                    {filteredPayslips.length > 0 ? (
                        ...
                        <div className="no-data-container">
                            <p>{searchTerm ? 'No payslips match your search.' : 'Your first payslip will appear here once generated by admin.'}</p>
                        </div>
                    )}
                </div>
